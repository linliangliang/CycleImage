...
import com.cycleimage.lib.DrawAllCornerImage;
import com.cycleimage.lib.DrawBottomCornerImage;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.with(this)
                ...
                .transform(new RoundCornersTransformation(20, new DrawAllCornerImage()))
                .into(imageView);
    }
    ...
    public static View getImageView(Context context, String url) {
        ...
        RelativeLayout.LayoutParams backgroundParams = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, 100);
